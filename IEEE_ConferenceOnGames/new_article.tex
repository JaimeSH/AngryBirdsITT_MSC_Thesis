...
\begin{abstract}
    ...
    At his level the composite generator has the following steps, for more details refer to the paper:
    ...
    \begin{enumerate}
    \item Generate the first generation of the population, consisting of randomly generated list of blocks.
    ...
    angle of the pieces, assign a fitness.
    \item Do the selection, crossover and mutation operations.
    \item Repeat the cycle.
    \item From the best individuals select composites. Several algorithms could be proposed for this step, for instance selcting clusters of blocks.
    \end{enumerate}
    ...
    Since there has to be a way to represent the structure of a level in a a way that
